...
from Products.UniFile.config import PROJECTNAME, GLOBALS
...
def install(self):
    ...
    setup_tool.setImportContext('profile-Products.UniFile:default')  # our profile and steps

    # run all import steps
    steps = ('skins','typeinfo', 'factorytool', 'rolemap', 'catalog', 'propertiestool')
    for step in steps:
